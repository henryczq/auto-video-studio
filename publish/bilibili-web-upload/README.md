...
<p align="center">
  <h1 align="center">🎬 Bilibili Web Upload</h1>
...
**Bilibili Web Upload** 是一个综合性的 B站工具包，将 6 个独立的 B站技能整合为一个统一的 Skill，提供从热门监控到视频投稿的全链路能力。
...
```bash
git clone https://github.com/wscats/bilibili-web-upload.git
cd bilibili-web-upload
...
result = await app.execute("publisher", "upload",
    file_path="./video.mp4",
    title="我的视频",
    description="通过 bilibili-web-upload 发布",
