...
author: wscats
license: MIT
homepage: https://github.com/wscats/bilibili-web-upload
repository: https://github.com/wscats/bilibili-web-upload
entry_point: main.py
required_env_vars: []
optional_env_vars:
  - BILIBILI_SESSDATA
...
>
> **🔗 Source:** [github.com/wscats/bilibili-web-upload](https://github.com/wscats/bilibili-web-upload)
...
result = await app.execute("publisher", "upload",
    file_path="./video.mp4",
    title="My Video",
    description="Published via bilibili-web-upload",
