...
from src.web_uploader import BilibiliWebVideo as WebUploader
...
async def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("  publisher     - Upload and publish videos (API)")
        print()
        print("Examples:")
        ...
        print()
        print("Web Uploader Examples:")
        print("  python examples/upload_video.py --login")
        print("  python examples/upload_video.py --file video.mp4 --title 'My Video'")
        print("  python examples/upload_video.py --file video.mp4 --tags 'vlog,生活'")
